...
const lessonsData = [
  {
    ...
    link: "/french-beginner/lesson-1",
  },
  {
    id: 2,
    title: "Alphabet et prononciation",
    description: "Maîtrisez l'alphabet français et les sons de base.",
    duration: "15 min",
    difficulty: "easy",
    completed: true,
    locked: false,
    ...
    link: "/french-beginner/lesson-2",
  },
  {
    id: 3,
    title: "Nombres de 1 à 20",
    description: "Comptez jusqu'à 20 et utilisez les nombres dans des phrases simples.",
    duration: "12 min",
    difficulty: "easy",
    completed: true,
    locked: false,
    ...
    link: "/french-beginner/lesson-3",
  },
  {
    id: 4,
    title: "Couleurs",
    description: "Nommez et utilisez les couleurs de base en français.",
    duration: "10 min",
    difficulty: "easy",
    completed: true,
    locked: false,
    ...
    link: "/french-beginner/lesson-4",
  },
  {
    id: 5,
    title: "Animaux",
    description: "Découvrez le vocabulaire des animaux communs.",
    duration: "15 min",
    difficulty: "easy",
    completed: true,
    locked: false,
    ...
    link: "/french-beginner/lesson-5",
  },
  {
    id: 6,
    title: "Famille",
    description: "Apprenez à parler des membres de la famille.",
    duration: "18 min",
    difficulty: "medium",
    completed: true,
    locked: false,
  ...
  },
  {
    ...
    link: "/french-beginner/lesson-7",
  },
  {
    id: 8,
    title: "Jours de la semaine",
    description: "Apprenez les jours et parlez de votre routine.",
    duration: "12 min",
    difficulty: "easy",
    completed: true,
    locked: false,
    ...
    link: "/french-beginner/lesson-8",
  },
  {
    id: 9,
    title: "Mois et saisons",
    description: "Parlez des dates et des périodes de l'année.",
    duration: "15 min",
    difficulty: "easy",
    completed: true,
    locked: false,
    progress: 100,
    image: "/seasons.jpg",
    link: "/french-beginner/lesson-9",
  },
  {
    id: 10,
    title: "Présent simple",
    description: "Maîtrisez les bases de la conjugaison française.",
    duration: "25 min",
    difficulty: "medium",
    completed: true,
    locked: false,
    ...
    link: "/french-beginner/lesson-10",
  },
]

export default function FrenchBeginnerPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="text-foreground">
            <div className="text-sm mb-2 text-muted-foreground">
              ...
              {" > "}
              <Link href="/french-course" className="hover:text-primary transition-colors">
                Francais
              </Link>
              {" > "}
              <span>Debutant</span>
            </div>
            <h1 className="text-4xl font-bold mb-2">Niveau Débutant - Français</h1>
            <p className="text-muted-foreground">Apprenez les bases du français avec nos leçons interactives</p>

            <div className="mt-6 bg-muted rounded-xl p-6">
              <div className="flex justify-between items-center mb-3">
                <span className="font-semibold">Progrès global: {progress}%</span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <SubscriptionGate
          title="Débloquez le cours de français débutant"
          description="Abonnez-vous pour accéder à toutes les leçons et aux supports de pratique."
        >
              ...
              >
                <div className="relative h-48 w-full bg-muted">
                  ...
                  <div className="absolute top-4 left-4">
                    ...
                    >
                      {lesson.completed ? "Terminé" : lesson.locked ? "Verrouillé" : "En cours"}
                    </span>
                  </div>
                </div>
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <div className="flex items-center justify-between text-sm text-muted-foreground mb-4">
                    ...
                    >
                      {lesson.difficulty === "easy" ? "Facile" : "Moyen"}
                    </span>
                  </div>
                  ...
                  <div className="flex gap-2 mt-auto">
                    {lesson.locked ? (
                      ...
                      <>
                        <Link href={lesson.link || `/french-beginner/lesson-${lesson.id}`} className="flex-1">
                      ...
                      <Link href={lesson.link || `/french-beginner/lesson-${lesson.id}`} className="flex-1">
                        <button className="w-full bg-primary text-primary-foreground py-2 rounded-lg font-medium hover:bg-primary/90 transition-colors flex items-center justify-center gap-2">
                          <PlayCircle size={16} />
                          {lesson.progress > 0 ? "Continuer" : "Commencer"}
                        </button>
                      </Link>
                    )}
                  </div>
