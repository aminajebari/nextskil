...
export default function ItalianIntermediateLesson3Page() {
  ...
  const verbs = [
    ...
    { infinitive: "essere", futuro: "sarò, sarai, sarà, saremo, sarete, saranno", english: "to be" },
    { infinitive: "avere", futuro: "avrò, avrai, avrà, avremo, avrete, avranno", english: "to have" },
    { infinitive: "andare", futuro: "andrò, andrai, andrà, andremo, andrete, andranno", english: "to go" },
  ]
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Il Futuro Semplice</h1>
          <p className="text-gray-600">Esprimi piani e previsioni future</p>
        </div>
        ...
        <Card className="mb-8 border-l-4 border-l-indigo-500">
          <CardContent className="pt-6">
            ...
            <p className="text-gray-700 leading-relaxed">
              Il futuro semplice si usa per esprimere azioni che avverranno nel futuro, fare previsioni e esprimere
              probabilità nel presente.
            </p>
          </CardContent>
        </Card>
          ...
          <div className="space-y-4">
            {verbs.map((verb) => (
              <div key={verb.infinitive} className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                ...
                <div className="text-sm text-gray-600">{verb.futuro}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mb-12">
          ...
          <Card className="mb-6">
            <CardContent className="pt-6">
              <h3 className="text-lg font-semibold mb-4">1. "Domani io _____ (andare) al mare."</h3>
              <div className="space-y-3">
                {[
                  { label: "vado", value: "incorrect" },
                  { label: "andrò", value: "correct" },
                  { label: "sono andato", value: "incorrect" },
                ].map((option) => (
                  <button
                    key={option.label}
              ...
              {quiz1Result === "correct" && (
                <div className="mt-4 p-3 bg-green-100 text-green-800 rounded-lg text-sm font-medium">
                  Corretto! "Andrò" è il futuro irregolare di "andare".
                </div>
              )}
            </CardContent>
          </Card>
