...
const lessonsData = [
  {
    id: 1,
    title: "Perfekt",
    description: "Lernen Sie, über vergangene Ereignisse und Handlungen zu sprechen.",
    duration: "20 min",
    difficulty: "medium",
    completed: false,
    locked: false,
  ...
  {
    id: 2,
    title: "Präsens Perfekt",
    description: "Meistern Sie das Präsens Perfekt für Lebenserfahrungen.",
    duration: "25 min",
    difficulty: "medium",
    completed: false,
    locked: false,
  ...
  },
  {
    id: 3,
    title: "Futur Zeiten",
    description: "Drücken Sie zukünftige Pläne und Vorhersagen aus.",
    duration: "22 min",
    difficulty: "medium",
    completed: false,
    locked: false,
  ...
  },
  {
    id: 4,
    title: "Modalverben",
    description: "Verwenden Sie können, müssen, sollen und andere Modalverben.",
    duration: "18 min",
    difficulty: "medium",
    completed: false,
    locked: false,
  ...
  {
    id: 5,
    title: "Komparative und Superlative",
    description: "Vergleichen Sie Dinge und beschreiben Sie Extreme.",
    duration: "20 min",
    difficulty: "medium",
    completed: false,
    locked: false,
...
export default function GermanIntermediatePage() {
      ...
      <div className="bg-card border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="text-foreground">
            <div className="text-sm mb-2 text-muted-foreground"><Link href="/" className="hover:text-primary transition-colors">Startseite</Link>{" > "}<Link href="/german-course" className="hover:text-primary transition-colors">Deutsch</Link>{" > "}<span>Mittelstufe</span></div>
            <h1 className="text-4xl font-bold mb-2">Mittelstufe - Deutsch</h1>
            <p className="text-muted-foreground">Bauen Sie auf Ihren Grundlagen mit mittlerer Grammatik und Vokabular auf</p>
