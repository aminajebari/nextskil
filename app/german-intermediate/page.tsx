  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="text-foreground">
            ...
            <p className="text-muted-foreground">
              Bauen Sie auf Ihren Grundlagen mit mittlerer Grammatik und Vokabular auf
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <SubscriptionGate
          title="Deutschkurs Mittelstufe freischalten"
          description="Abonnieren Sie, um Zugang zu allen Lektionen und Übungsmaterialien zu erhalten."
        >
              ...
              >
                <div className="relative h-48 w-full bg-muted">
                  ...
                  <div className="absolute top-4 left-4">
                    ...
                    >
                      {lesson.completed ? "Abgeschlossen" : lesson.locked ? "Gesperrt" : "Verfügbar"}
                    </span>
                  </div>
                </div>
