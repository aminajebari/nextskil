...
const lessonsData = [
  {
    ...
    description: "Master complex sentence structures and advanced grammar.",
    duration: "30 min",
    difficulty: "hard",
    completed: true,
    locked: false,
    progress: 100,
    image: "/advanced-grammar-structures.jpg",
  },
  {
    id: 2,
    ...
    locked: false,
    progress: 100,
    image: "/business-english-office.jpg",
  },
  {
    id: 3,
    title: "Academic Writing",
    description: "Write essays, reports, and academic papers.",
    duration: "40 min",
    difficulty: "hard",
    completed: true,
    locked: false,
    progress: 100,
    image: "/academic-writing-desk.jpg",
  },
  {
    id: 4,
    title: "Idioms and Expressions",
    description: "Learn common idioms and colloquial expressions.",
    duration: "25 min",
    difficulty: "hard",
    completed: true,
    locked: false,
    progress: 100,
    image: "/english-idioms-phrases.jpg",
  },
  {
    id: 5,
    title: "Literature and Culture",
    description: "Explore English literature and cultural contexts.",
    duration: "45 min",
    difficulty: "hard",
    completed: true,
    locked: false,
    progress: 100,
    image: "/english-literature-books.jpg",
  },
]

export default function EnglishAdvancedPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-card border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="text-foreground">
            ...
            <h1 className="text-4xl font-bold mb-2">Advanced Level - English</h1>
            <p className="text-muted-foreground">Master advanced English for professional and academic success</p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <SubscriptionGate
          title="Unlock English Advanced Course"
          description="Subscribe to access all advanced lessons and practice materials."
        >
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <div className="flex gap-2 mt-auto">
                    {lesson.locked ? (
                      ...
                      <>
                        <Link href={`/english-advanced/lesson-${lesson.id}`} className="flex-1">
