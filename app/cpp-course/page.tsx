...
import Certificate from "@/components/cpp-certificate"
...
export default function CPPCoursePage() {
  ...
  const [completedLessons, setCompletedLessons] = useState<Set<string>>(
    new Set(
      cppCourseData.modules.flatMap((module, moduleIndex) =>
  ...
  return (
    <SubscriptionGate
      ...
      description="Access the full interactive C++ Professional Mastery Course with projects and certification."
    >
      <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="mb-6 p-6 rounded-xl bg-gradient-to-r from-primary/10 to-secondary/10 border-2 border-secondary/30">
            ...
            <p className="text-muted-foreground mb-4">
              Master C++ from fundamentals to advanced techniques. Learn OOP, memory management, STL, and build
              professional applications. Complete all modules, pass the final exam, and earn your certificate!
            </p>
