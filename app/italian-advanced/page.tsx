...
const lessonsData = [
  {
    id: 1,
    title: "Strutture Grammaticali Avanzate",
    description: "Padroneggia strutture di frasi complesse e grammatica avanzata.",
    duration: "30 min",
    difficulty: "hard",
    completed: false,
    locked: false,
  ...
  },
  {
    ...
    description: "Vocabolario professionale e competenze comunicative.",
    duration: "35 min",
    difficulty: "hard",
    completed: false,
    locked: false,
  ...
  },
  {
    ...
    description: "Scrivi saggi, relazioni e articoli accademici.",
    duration: "40 min",
    difficulty: "hard",
    completed: false,
    locked: false,
  ...
  },
  {
    ...
    description: "Impara espressioni idiomatiche e colloquiali comuni.",
    duration: "25 min",
    difficulty: "hard",
    completed: false,
    locked: false,
  ...
  {
    id: 5,
    title: "Letteratura e Cultura",
    description: "Esplora la letteratura italiana e i contesti culturali.",
    duration: "45 min",
    difficulty: "hard",
    completed: false,
    locked: false,
...
export default function ItalianAdvancedPage() {
      ...
      <div className="bg-card border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="text-foreground">
            <div className="text-sm mb-2 text-muted-foreground"><Link href="/" className="hover:text-primary transition-colors">Home</Link>{" > "}<Link href="/italian-course" className="hover:text-primary transition-colors">Italiano</Link>{" > "}<span>Avanzato</span></div>
            <h1 className="text-4xl font-bold mb-2">Livello Avanzato - Italiano</h1>
            <p className="text-muted-foreground">Padroneggia l'italiano avanzato per il successo professionale e accademico</p>
