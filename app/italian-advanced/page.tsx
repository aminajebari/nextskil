  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="text-foreground">
            ...
            <p className="text-muted-foreground">
              Padroneggia l'italiano avanzato per il successo professionale e accademico
            </p>
            <div className="mt-6 bg-muted rounded-xl p-6">
              <div className="flex justify-between items-center mb-3">
                <span className="font-semibold">Progresso Globale: {progress}%</span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <SubscriptionGate
          title="Sblocca il Corso Avanzato di Italiano"
          description="Iscriviti per accedere a tutte le lezioni avanzate."
        >
              ...
              >
                <div className="relative h-48 w-full bg-muted">
                  ...
                  <div className="absolute top-4 left-4">
                    ...
                    >
                      {lesson.completed ? "Completato" : lesson.locked ? "Bloccato" : "Disponibile"}
                    </span>
                  </div>
                </div>
