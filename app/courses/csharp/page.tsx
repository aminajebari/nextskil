  ...
  const courseModules = [
    {
      ...
      lessons: [
        ...
        { id: 2, title: ".NET Framework Overview", duration: "18 min", type: "video" },
        { id: 3, title: "Variables and Data Types", duration: "25 min", type: "video" },
        { id: 4, title: "Your First C# Application", duration: "30 min", type: "practice" },
      ],
    },
    {
      id: 2,
      ...
      lessons: [
        ...
        { id: 6, title: "Loops and Iterations", duration: "25 min", type: "video" },
    ...
    },
    {
      ...
      lessons: [
        ...
        { id: 10, title: "Properties and Encapsulation", duration: "25 min", type: "video" },
        { id: 11, title: "Inheritance and Polymorphism", duration: "32 min", type: "video" },
        { id: 12, title: "Interfaces and Abstract Classes", duration: "28 min", type: "video" },
    ...
    },
    {
      ...
      lessons: [
        { id: 14, title: "Lists and Arrays", duration: "25 min", type: "video" },
        { id: 15, title: "Dictionaries and Sets", duration: "22 min", type: "video" },
        { id: 16, title: "Introduction to LINQ", duration: "30 min", type: "video" },
        { id: 17, title: "Advanced LINQ Queries", duration: "28 min", type: "practice" },
      ],
    },
    {
      id: 5,
      title: "Advanced C#",
      lessons: [
        { id: 18, title: "Async and Await", duration: "35 min", type: "video" },
        { id: 19, title: "Delegates and Events", duration: "30 min", type: "video" },
        { id: 20, title: "Exception Handling", duration: "25 min", type: "video" },
        { id: 21, title: "Final Capstone Project", duration: "90 min", type: "practice" },
      ],
    },
  ]
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div className="flex-1">
              ...
              <p className="text-lg text-primary-foreground/90 mb-4">
                Master C# and .NET development from fundamentals to advanced features including async programming and
                LINQ.
              </p>
