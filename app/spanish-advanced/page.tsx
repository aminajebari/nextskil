...
const lessonsData = [
  {
    id: 1,
    title: "Estructuras Gramaticales Avanzadas",
    description: "Domina estructuras de oraciones complejas y gramática avanzada.",
    duration: "30 min",
    difficulty: "hard",
    completed: true,
    locked: false,
  ...
  },
  {
    ...
    description: "Vocabulario profesional y habilidades de comunicación.",
    duration: "35 min",
    difficulty: "hard",
    completed: true,
    locked: false,
  ...
  },
  {
    ...
    description: "Escribe ensayos, informes y artículos académicos.",
    duration: "40 min",
    difficulty: "hard",
    completed: true,
    locked: false,
  ...
  },
  {
    ...
    description: "Aprende modismos y expresiones coloquiales comunes.",
    duration: "25 min",
    difficulty: "hard",
    completed: true,
    locked: false,
  ...
  },
  {
    ...
    description: "Explora la literatura española y los contextos culturales.",
    duration: "45 min",
    difficulty: "hard",
    completed: true,
    locked: false,
...
export default function SpanishAdvancedPage() {
      ...
      <div className="bg-card border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="text-foreground">
            <div className="text-sm mb-2 text-muted-foreground"><Link href="/" className="hover:text-primary transition-colors">Inicio</Link>{" > "}<Link href="/spanish-course" className="hover:text-primary transition-colors">Español</Link>{" > "}<span>Avanzado</span></div>
            <h1 className="text-4xl font-bold mb-2">Nivel Avanzado - Español</h1>
            <p className="text-muted-foreground">Domina el español avanzado para el éxito profesional y académico</p>
