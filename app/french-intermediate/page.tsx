...
const lessonsData = [
  {
    id: 1,
    title: "Passé Composé",
    description: "Apprenez à parler d'événements et d'actions passés.",
    duration: "20 min",
    difficulty: "medium",
    completed: false,
    locked: false,
    progress: 0,
    image: "/french-past-tense.jpg",
  },
  {
    id: 2,
    title: "Présent Parfait",
    description: "Maîtrisez le présent parfait pour les expériences de vie.",
    duration: "25 min",
    difficulty: "medium",
    completed: false,
    locked: false,
    progress: 0,
    image: "/french-grammar-book.jpg",
  },
  {
    id: 3,
    title: "Temps Futurs",
    description: "Exprimez des plans et des prédictions futurs.",
    duration: "22 min",
    difficulty: "medium",
    completed: false,
    locked: false,
    progress: 0,
    image: "/french-future-calendar.jpg",
  },
  {
    id: 4,
    title: "Verbes Modaux",
    description: "Utilisez pouvoir, devoir, vouloir et autres modaux.",
    duration: "18 min",
    difficulty: "medium",
    completed: false,
    locked: false,
    progress: 0,
    image: "/french-modal-verbs.jpg",
  },
  {
    id: 5,
    title: "Comparatifs et Superlatifs",
    description: "Comparez des choses et décrivez des extrêmes.",
    duration: "20 min",
    difficulty: "medium",
    completed: false,
    locked: false,
    progress: 0,
    image: "/french-comparison.jpg",
  },
]

export default function FrenchIntermediatePage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="bg-card border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="text-foreground">
            ...
            <h1 className="text-4xl font-bold mb-2">Niveau Intermédiaire - Français</h1>
            <p className="text-muted-foreground">
              Développez vos bases avec la grammaire et le vocabulaire intermédiaires
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <SubscriptionGate
          title="Débloquez le Cours Intermédiaire de Français"
          description="Abonnez-vous pour accéder à toutes les leçons et au matériel de pratique."
        >
              ...
              >
                <div className="relative h-48 w-full bg-muted">
                  ...
                  <div className="absolute top-4 left-4">
                    ...
                    >
                      {lesson.completed ? "Terminé" : lesson.locked ? "Verrouillé" : "Disponible"}
                    </span>
                  </div>
                </div>
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <div className="flex gap-2 mt-auto">
                    {lesson.locked ? (
                      ...
                      <>
                        <Link href={`/french-intermediate/lesson-${lesson.id}`} className="flex-1">
