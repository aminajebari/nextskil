...
import { exampleExamQuestions } from "@/data/javascript-example-exam-data"
    ...
    return (
      <Card className="max-w-4xl mx-auto">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-3xl">{passed ? "Excellent Work!" : "Keep Practicing!"}</CardTitle>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex gap-4 justify-center pt-4">
            <Button onClick={handleRetake} size="lg" variant="outline" className="gap-2 bg-transparent">
      ...
      <Card className="border-2 border-primary/20">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex justify-between items-center pt-4 border-t">
            <Button onClick={handlePrevious} disabled={currentQuestion === 0} variant="outline" size="lg">
              Previous
            </Button>
