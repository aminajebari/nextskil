...
export default function PythonCertificate({ onClose, progress, preview = false }: CertificateProps) {
  ...
  return (
    <div className="min-h-screen bg-background/95 backdrop-blur-sm flex items-center justify-center p-4">
      <Card className="max-w-4xl w-full p-8 relative">
        {preview && (
          <Badge className="absolute top-8 left-8 text-sm bg-yellow-600/20 text-yellow-600 border-yellow-600">
            Preview Mode
          </Badge>
        )}
        ...
        <div className="text-center space-y-6 py-8">
          <div className="flex justify-center">
            <div className="w-20 h-20 rounded-full bg-yellow-600/10 flex items-center justify-center">
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">Python Programming Course</p>
          </div>
          ...
          <div className="py-8 space-y-4">
            ...
            <p className="text-2xl font-semibold text-yellow-600">Complete Python Programming Training</p>
            <p className="text-muted-foreground">
              Demonstrating mastery of Python fundamentals, data structures, OOP, file handling, and advanced
        ...
        <div className="absolute inset-0 border-8 border-yellow-600/20 rounded-lg pointer-events-none" />
        <div className="absolute inset-2 border-2 border-yellow-600/10 rounded-lg pointer-events-none" />
      </Card>
    </div>
  )
}
