...
export default function CSSCertificate({ onClose, progress, preview = false }: CertificateProps) {
  ...
  return (
    <div className="min-h-screen bg-background/95 backdrop-blur-sm flex items-center justify-center p-4">
      <Card className="max-w-4xl w-full p-8 relative">
        {preview && (
          <Badge className="absolute top-8 left-8 text-sm bg-blue-600/20 text-blue-600 border-blue-600">
            Preview Mode
          </Badge>
        )}
        ...
        <div className="text-center space-y-6 py-8">
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">CSS Mastery Course</p>
          </div>

          <div className="py-8 space-y-4">
            <p className="text-lg">This certifies that</p>
            <div className="py-4 border-b-2 border-blue-600 mx-auto max-w-md">
            ...
            <p className="text-2xl font-semibold text-blue-600">Complete CSS Styling & Layout Training</p>
            <p className="text-muted-foreground">
              Demonstrating mastery of CSS selectors, flexbox, grid, animations, responsive design, and modern CSS
              techniques
            </p>
          </div>
          ...
          <div className="flex gap-4 justify-center pt-6">
            {!preview && (
              <Button onClick={handleDownload} size="lg" className="gap-2 bg-blue-600 hover:bg-blue-700">
        ...
        <div className="absolute inset-0 border-8 border-blue-600/20 rounded-lg pointer-events-none" />
        <div className="absolute inset-2 border-2 border-blue-600/10 rounded-lg pointer-events-none" />
      </Card>
    </div>
  )
}
