...
export default function CSharpCertificate({ onClose, progress, preview = false }: CertificateProps) {
  ...
  return (
    <div className="min-h-screen bg-background/95 backdrop-blur-sm flex items-center justify-center p-4">
      <Card className="max-w-4xl w-full p-8 relative">
        {preview && (
          <Badge className="absolute top-8 left-8 text-sm bg-purple-600/20 text-purple-600 border-purple-600">
            Preview Mode
          </Badge>
        )}
        ...
        <div className="text-center space-y-6 py-8">
          ...
          <div className="space-y-2">
            <h1 className="text-4xl font-bold text-purple-600">Certificate of Completion</h1>
            <p className="text-muted-foreground">C# Programming Course</p>
          </div>

          <div className="py-8 space-y-4">
            <p className="text-lg">This certifies that</p>
            <div className="py-4 border-b-2 border-purple-600 mx-auto max-w-md">
            ...
            <p className="text-2xl font-semibold text-purple-600">Complete C# .NET Programming Training</p>
            <p className="text-muted-foreground">
              Demonstrating mastery of C# fundamentals, OOP, LINQ, async programming, and .NET development
            </p>
          </div>
          ...
          <div className="flex gap-4 justify-center pt-6">
            {!preview && (
              <Button onClick={handleDownload} size="lg" className="gap-2 bg-purple-600 hover:bg-purple-700">
        ...
        <div className="absolute inset-0 border-8 border-purple-600/20 rounded-lg pointer-events-none" />
        <div className="absolute inset-2 border-2 border-purple-600/10 rounded-lg pointer-events-none" />
      </Card>
    </div>
  )
}
