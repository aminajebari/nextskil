...
import { PlayCircle, CheckCircle2, Lock, ArrowLeft, Code2, Eye, X, Award, ChevronRight } from "lucide-react"
...
import LessonContent from "./javascript/lesson-content"
import ModuleQuiz from "./javascript/module-quiz"
import FinalExam from "./javascript/final-exam"
import Certificate from "./javascript/certificate"
import ExamplePracticeExam from "./javascript/example-practice-exam"
import { courseData } from "@/data/javascript-course-data"

export default function JavaScriptCoursePlatform() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="border-b bg-card sticky top-0 z-10 shadow-sm">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-2xl font-bold text-balance">JavaScript Mastery</h1>
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="mb-6 p-6 rounded-xl bg-gradient-to-r from-primary/10 to-secondary/10 border-2 border-primary/20">
          <h2 className="text-3xl font-bold mb-2 text-balance">JavaScript Essentials Course</h2>
          <p className="text-muted-foreground mb-4">
            Master JavaScript from fundamentals to advanced techniques. Build real-world projects, pass quizzes, and
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <div className="flex items-center gap-2 bg-background/80 px-4 py-2 rounded-lg">
              ...
              <div>
                ...
                <p className="font-bold">{progress >= 100 && examCompleted ? "Available" : "In Progress"}</p>
              </div>
            </div>
          </div>
        </div>
                  ...
                  <div className="space-y-1 p-4">
                    ...
                    <div className="border-t pt-4 mt-4">
                      ...
                      >
                        ...
                        <p className="text-sm mt-1 text-muted-foreground">Sample questions with results</p>
                      </button>
                      ...
                      >
                        ...
                        <p className="text-sm mt-1">Master Test</p>
                        {progress < 100 && (
                  ...
                  <Tabs value={activeTab} onValueChange={setActiveTab}>
                    ...
                    <TabsContent value="lesson">
                      <LessonContent
                        ...
                        moduleTitle={courseData.modules[selectedModule].title}
                        onComplete={markLessonComplete}
                        isComplete={isLessonComplete(selectedModule, selectedLesson)}
                        lessonNumber={selectedLesson + 1}
                        totalLessons={courseData.modules[selectedModule].lessons.length}
                      />
                    </TabsContent>
